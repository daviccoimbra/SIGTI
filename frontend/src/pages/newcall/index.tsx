...
const NewCall = () => {
  ...
  const onSubmit = async (
    ...
    try {
      ...
      showMessage(
        `Erro ao criar chamado: ${errorMsg}`,
        "error"
      );
    }
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-[#f8f9fa] pb-5">
      <h1 className="text-2xl mb-6 text-bold mt-2 font-bold">
        Novo Chamado
      </h1>

      <p className="text-[13px] text-gray-600 mb-3">
        Preencha os dados abaixo
        para abrir um novo ticket
      </p>

      <form
        className="flex justify-items-start w-[60%] md:w-[40%] bg-[#fff] p-4 shadow rounded-lg border-[2px] pb-5"
      ...
      >
        <div className="flex flex-col w-full">
          <div className="flex flex-col">
            <label className="text-[15px] mb-3 font-bold">
              Título do
              Chamado*
            </label>
          ...
          <div className="flex flex-col">
            ...
            <textarea
              className="text-gray-500 text-[12px] p-2 rounded-md border border-gray-300 focus:border-[#1e40af] focus:outline-none"
          ...
          <div className="w-full mt-5 flex flex-col gap-2 md:flex-row md:justify-between md:h-[40px]">
            <input
              ...
              className="border rounded-lg w-full md:w-[70%] bg-[#2563eb] text-white font-bold hover:bg-[#2563eb]/50 transition duration-200 disabled:opacity-50"
            />
